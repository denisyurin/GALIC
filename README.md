...
#2. The putting of the time-averaged velocity structure to the target one is not fully successful in the case of the disk. Which means that one can still see the rapid change of the velocity structure in the disk that is not related to the disk relaxation.
